...
chmod +x menus/utility.sh modules/utility/02-temp-tunnel.sh

bash -n menus/utility.sh
bash -n modules/utility/02-temp-tunnel.sh

echo
echo "✅ Step 12A completed successfully."
echo "Now run:"
echo "git add . && git commit -m 'Add temporary tunnel proxy menu skeleton' && git push"
